"""
Generic filesystem / (de)serialization helper functions shared across
components: read/write YAML, save/load pickled objects (model,
vectorizer), save/load numpy arrays.
"""
import os
import sys
import pickle
